...
const ProfileExperience = () => {
    ...
    let handleDelete = (id)=>{
        Swal.fire({
        title: 'Are you sure?',
        text: "Deleted your's experience",
        icon: 'question',
    ...
    <Row >
        <Col >
            <div className='experienceSection'>
                <div className=''>
                    <h1 className='experience_text text-white'>Exper<span>ience</span></h1>
                    <Link to="/experience"><Button variant="success">ADD YOUR'S EXPERIENCE</Button></Link>
                </div>
            ...
            <Modal show={modelShow} onHide={handleClose}>
                  ...
                  <Modal.Body>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control onChange={Skill} type="email" placeholder="Skill Name" />
                    </Form.Group>
